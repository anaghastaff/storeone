...
const AddressForm = ({
  ...
  const handleChange=(e)=>{
   ...
   const [formState, formAction] = useFormState(updateCustomerShippingAddress, {success: false, error:null, addressId: address?.id} )
  return  <form action={formAction}>
      ...
      <SubmitButton variant="contained" size="large" color="error" disabled={!checked}>
        Save Changes
      </SubmitButton>
      <Button variant="outlined" size="large" color="error" onClick={handleCancel}>Cancel</Button>
      </Grid>
      <ErrorMessage error={formState.error as string} data-testid="error-message-add-new-address" />
        </form>
        };

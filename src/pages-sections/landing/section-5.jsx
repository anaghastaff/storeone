        ...
        <Box my={25}>
          ...
          xs: 4
            ...
            <Grid item lg={4} md={5} sm={6} xs={10}>
              <ImageBox>
                <LazyImage width={413} height={660} src="/assets/images/landing/product-model.png" alt="product-model" />
              </ImageBox>
            </Grid>
        ...
        <Box my={25}>
          ...
          xs: 4
            ...
            <Grid item md={6} xs={12}>
              <ImageBox>
                <LazyImage width={634} height={312} alt="rest-api-endpoint" src="/assets/images/landing/rest-api-endpoint.png" />
              </ImageBox>
            </Grid>
          </Grid>
        </Box>

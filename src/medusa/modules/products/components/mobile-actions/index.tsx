    ...
    <>
      <Box
        sx={{
          ...
          left: 0,
          right: 0,
          pointerEvents: (theme) => (!show ? 'none' : 'auto')
        }}
      >
        <Transition
          as={Fragment}
        ...
        >
          <div className="bg-white flex flex-col gap-y-3 justify-center items-center text-large-regular p-4 h-full w-full border-t border-gray-200" data-testid="mobile-actions">
                ...
                <div className="flex items-end gap-x-2 text-ui-fg-base">
                  ...
                  <Box
                    sx={{
                      color: (theme) =>
                        selectedPrice.price_type === "sale"
                          ? theme.palette.text.primary // Use your interactive color here
                          : undefined,
                    }}
                  >
            ...
            <div className="grid grid-cols-2 w-full gap-x-4">
              <Button onClick={open} variant="contained" className="w-full" data-testid="mobile-actions-button">
